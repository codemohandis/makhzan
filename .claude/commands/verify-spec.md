...
allowed-tools: Read, Glob, Grep, Bash(npx tsc --noEmit)
---
...
Remaining Definition of Done items require manual browser verification — see ## 4. Definition of Done in the spec.
```
